...
def main():
    ...
    parser.add_argument("--symbols", type=str, default="SOLUSDT,XAUTUSDT", help="Comma-separated list of symbols (e.g. SOLUSDT,BTCUSDT)")
    parser.add_argument("--timeframes", type=str, default="3m,5m,15m,1h", help="Comma-separated timeframes (e.g. 15m,1h)")
    ...
    optimize_on = [t.strip() for t in args.optimize_on.split(",")]
    cash = args.cash
